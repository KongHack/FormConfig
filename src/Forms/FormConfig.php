...
class FormConfig implements FieldContainerInterface
{
    ...
    /** @var array<string, FormField|FormArrayElement|Base> */
    ...
    public function setRequirements(array $requirements): static
    {
        if (count($requirements) > 0) {
            ...
            foreach ($requirements as $name => $level) {
                if (array_key_exists($name, $this->fields)) {
                    /** @var FormField|FormArrayElement|Base $field */
    ...
    public function setValuesFromObject(mixed $object): static
    {
        ...
        foreach ($this->fields as $name => $field) {
            ...
            if ($mft) {
                ...
                if (
                    $field->getNameRaw() != $this->csrf['name']
                ...
                if (
                    method_exists($field, 'getHelpText')
     ...
     * @throws \Exception
     *
     * @return array<string, array<string, FormField|FormArrayElement|Base>>
     */
    ...
    /**
     * @return array<string, FormField|FormArrayElement|Base>
     */
    ...
    /**
     * @param array<string, FormField|FormArrayElement|Base> $fields
     *
     * @return void
     */
